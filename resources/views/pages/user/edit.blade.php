...
@section('content')
<!--creat driver form -->
<form method="POST" class="center" action="/dashboard/users/{{$user->id}}">
  @method('patch')
  @csrf
  <!-- driver info sec-->
  <h2 class="font-weight-bold text-primary">{{ __('Edit User :') }}</h2>
  <div class="row">
    <!-- name -->
    <div class="col-lg-4">
      <div class="form-group">
        <label for="name">Name<span class="text-red">*</span></label>
        <input type="text" class="form-control {{$errors->has('name') ? 'is-invalid' : ''}}"value="{{$user->name}}" placeholder="Full Name"
          name="name" id="name">
        @if($errors->has('name'))
    ...
    <div class="col-lg-8">
      <div class="form-group">
        <label for="acQualification">Academic qualification<span class="text-red">*</span></label>
        <input type="text" value="{{$user->acQualification}}"class="form-control {{$errors->has('acQualification') ? 'is-invalid' : ''}}"
  ...
  <div class="row">
    ...
    <div class="col-lg-8">
      <div class="form-group">
        ...
        <input type="email" value="{{$user->email}}"class="form-control {{$errors->has('email') ? 'is-invalid' : ''}}"
    ...
    <div class="col-lg-4">
      <div class="form-group">
        ...
        <input type="password" value="{{$user->password}}"class="form-control {{$errors->has('password') ? 'is-invalid' : ''}}"
  ...
  <div class="row">
    ...
    <div class="col-lg-6">
      <div class="form-group">
        ...
        <input type="date" value="{{$user->brithDate}}"class="form-control {{$errors->has('brithDate') ? 'is-invalid' : ''}}" name="brithDate"
          id="brithDate">
    ...
    <div class="col-lg-6">
      <div class="form-group">
        ...
        <input type="number"value="{{$user->phoneNum}}" class="form-control {{$errors->has('phoneNum') ? 'is-invalid' : ''}}"
  ...
  <div class="row">
    ...
    <div class="col-lg-6">
      <div class="form-group">
        ...
        <input type="number"value="{{$user->nationalNum}}" class="form-control {{$errors->has('nationalNum') ? 'is-invalid' : ''}}"
    ...
    <div class="col-lg-6">
      <div class="form-group">
        ...
        <input type="number"value="{{$user->workingHrs}}" class="form-control {{$errors->has('workingHrs') ? 'is-invalid' : ''}}"
  ...
  <div class="row">
    ...
    <div class="col-lg-4">
      <div class="form-group">
        ...
        <select value="{{$user->type}}" class="form-control {{$errors->has('type') ? 'is-invalid' : ''}}" id="type" name="type">
